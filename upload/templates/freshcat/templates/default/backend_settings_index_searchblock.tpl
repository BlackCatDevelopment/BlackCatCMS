			...
			<select name="search" id="fc_search">
				<option value="public"{% if search.search == 'public' %} selected="selected"{% endif %}>{{translate('Public')}}</option>
				<option value="private"{% if search.search == 'private' %} selected="selected"{% endif %}>{{translate('Private')}}</option>
				<option value="registered"{% if search.search == 'registered' %} selected="selected"{% endif %}>{{translate('Registered')}}</option>
				<option value="none"{% if search.search == 'none' %} selected="selected"{% endif %}>{{translate('None')}}</option>
			</select>
			...
			<select name="search_template" id="fc_search_template">
				...
				<option value="{{search_template.VALUE}}"{% if search_template.SELECTED %} selected="selected"{% endif %}>{{search_template.NAME}}</option>
				{% endfor %}
			</select>
			<div class="clear_sp"></div>
            ...
            <div class="fc_settings_max_large">
              <input type="checkbox" class="fc_checkbox_jq" name="search_cfg_search_images" id="fc_search_cfg_search_images" value="true" {% if search.cfg_search_images == 'true' %} checked="checked"{% endif %}/>
			...
			<select name="search_cfg_content_image" id="fc_searchcfg_content_image">
				<option value="none"{% if search.cfg_content_image == 'none' %} selected="selected"{% endif %}>{{translate('None')}}</option>
				<option value="first"{% if search.cfg_content_image == 'first' %} selected="selected"{% endif %}>{{translate('First')}}</option>
				<option value="last"{% if search.cfg_content_image == 'last' %} selected="selected"{% endif %}>{{translate('Last')}}</option>
				<option value="random"{% if search.cfg_content_image == 'random' %} selected="selected"{% endif %}>{{translate('Random')}}</option>
			</select>
			<div class="clear_sp"></div>
            ...
            <div class="fc_settings_max_large">
              <input type="checkbox" class="fc_checkbox_jq" name="search_cfg_search_description" id="fc_search_cfg_search_description" value="true" {% if search.cfg_search_description == 'true' %} checked="checked"{% endif %}/>
			  <label for="fc_search_cfg_search_description">{{translate('Search for page descriptions')}}:</label>
            </div>
			<div class="clear_sp"></div>

            <div class="fc_settings_max_large">
              <input type="checkbox" class="fc_checkbox_jq" name="search_cfg_show_description" id="fc_search_cfg_show_description" value="true" {% if search.cfg_show_description == 'true' %} checked="checked"{% endif %}/>
			  <label for="fc_search_cfg_show_description">{{translate('Show page description in search result')}}:</label>
            </div>
			<div class="clear_sp"></div>

            <div class="fc_settings_max_large">
              <input type="checkbox" class="fc_checkbox_jq" name="search_cfg_search_keywords" id="fc_search_cfg_search_keywords" value="true" {% if search.cfg_search_keywords == 'true' %} checked="checked"{% endif %}/>
			  <label for="fc_search_cfg_search_keywords">{{translate('Search for page keywords')}}:</label>
            </div>
			<div class="clear_sp"></div>

            <div class="fc_settings_max_large">
              <input type="checkbox" class="fc_checkbox_jq" name="search_cfg_search_non_public_content" id="fc_search_cfg_search_non_public_content" value="true" {% if search.cfg_search_non_public_content == 'true' %} checked="checked"{% endif %}/>
