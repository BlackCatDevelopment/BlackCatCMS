            ...
            <div class="fc_settings_max">
                ...
                <div class="fc_settings_label" id="fc_page_down">
                    <input type="checkbox" class="fc_checkbox_jq" name="maintenance_mode" id="fc_maintenance_mode" value="on" {% if values.maintenance_mode == 'on' %} checked="checked"{% endif %}>
			...
			<select name="er_level" id="fc_er_level">
				...
				{% for er in er_levels %}
				<option value="{{er.VALUE}}"{% if er.SELECTED %} selected="selected"{% endif %}>{{er.NAME|raw}}</option>
				{% endfor %}
			</select>
			<div class="clear_sp"></div>
			...
			<select name="page_level_limit" id="fc_page_level_limit">
				{% for count in 0..10 %}
				<option value="{{count}}"{% if count == values.page_level_limit %} selected="selected"{% endif %}>{{count}}</option>
				{% endfor %}
			</select><br>
			...
			<div class="fc_settings_max">
				...
				<div class="fc_settings_label" id="fc_page_trash">
					<input type="radio" class="fc_radio_jq" name="page_trash" id="fc_page_trash_disabled" value="false"{% if values.page_trash == 'false' or values.page_trash == false %} checked="checked"{% endif %}>
					<label for="fc_page_trash_disabled" title="{{translate('Pages are deleted at once')}}">{{translate('Disabled')}}</label>
					<input type="radio" class="fc_radio_jq" name="page_trash" id="fc_page_trash_inline" value="true"{% if values.page_trash == 'true' or values.page_trash is same as (true) %} checked="checked"{% endif %}>
			...
			<div class="fc_settings_max">
				<input type="checkbox" class="fc_checkbox_jq" name="manage_sections" id="fc_manage_sections" value="true" {% if values.manage_sections %} checked="checked"{% endif %}>
				...
				<input type="checkbox" class="fc_checkbox_jq" name="section_blocks" id="fc_section_blocks" value="true" {% if values.section_blocks %} checked="checked"{% endif %}>
				...
				<input type="checkbox" class="fc_checkbox_jq" name="multiple_menus" id="fc_multiple_menus" value="true" {% if values.multiple_menus %} checked="checked"{% endif %}>
				...
				<input type="checkbox" class="fc_checkbox_jq" name="page_languages" id="fc_page_languages" value="true" {% if values.page_languages %} checked="checked"{% endif %}>
			...
			{% endif %}
				...
				<input type="checkbox" class="fc_checkbox_jq" name="intro_page" id="fc_intro_page" value="true" {% if values.intro_page %} checked="checked"{% endif %}>
			...
			{% if DISPLAY_ADVANCED %}
				<input type="checkbox" class="fc_checkbox_jq" name="homepage_redirection" id="fc_homepage_redirection" value="true" {% if values.homepage_redirection %} checked="checked"{% endif %}>
			...
			{% else %}
				<input type="hidden" name="homepage_redirection" value="{% if values.homepage_redirection %}true{% else %}false{% endif %}">
			{% endif %}
			</div>
			<div class="clear_sp"></div>
