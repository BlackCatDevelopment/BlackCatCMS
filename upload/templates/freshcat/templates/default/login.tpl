...
<body class="fc_gradient3">
	...
	<div id="shake_wrapper">
		<div id="fc_forms" class="fc_br_all fc_shadow_big">
			...
			<form name="login" action="{{ACTION_URL}}" method="post" id="fc_login_form" class="fc_gradient1 fc_br_bottom fc_border">
				<h2 class="setNewPassword{% if not otp %} hidden{% endif %}" style="margin-top:0;">{{translate('Set new password')}}</h2>
				<p class="setNewPasswordHidden{% if otp %} hidden{% endif %}">
				...
				<p class="setNewPassword{% if not otp %} hidden{% endif %}">
			...
			<form name="forgot_pass" action="{{CAT_ADMIN_URL}}/login/forgot/ajax_forgot.php" method="post" id="fc_login_forgot_form" class="fc_gradient1 fc_br_bottom fc_border">
				<p>
					...
					<input type="text" maxlength="255" name="email" value="{% if EMAIL %}{{EMAIL}}{% endif %}" id="fc_forgot">
	...
	<div class="fc_gradient4 fc_license">
		<p class="right"><a href="https://blackcat-cms.org" title="Black Cat CMS Core" target="_blank">Black Cat CMS Core</a> is released under the
