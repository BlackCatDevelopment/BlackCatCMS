			...
			<select name="frontend_signup" id="fc_list_FRONTEND_signup">
				...
				<option value="{{group.VALUE}}"{% if group.CHECKED %} selected="selected"{% endif %}>{{group.NAME}}</option>
				{% endfor %}
			</select>
            <hr>
			{% endif %}
            ...
            <div class="fc_settings_max">
			    <input type="checkbox" class="fc_checkbox_jq" name="users_allow_mailaddress" id="fc_users_allow_mailaddress" value="true" {% if values.users_allow_mailaddress %} checked="checked"{% endif %}>
			...
			<div class="fc_settings_max">
				<input type="checkbox" class="fc_checkbox_jq" name="frontend_login" id="fc_list_FRONTEND_login" value="true" {% if values.frontend_login %} checked="checked"{% endif %}>
            ...
            <div class="fc_settings_max">
                <input type="checkbox" class="fc_checkbox_jq" name="initial_page" id="fc_initial_page" value="true" {% if values.initial_page %} checked="checked"{% endif %}>
			...
			<div class="fc_settings_max">
				<input type="checkbox" class="fc_checkbox_jq" name="home_folders" id="fc_home_folders" value="true" {% if values.home_folders %} checked="checked"{% endif %}>
