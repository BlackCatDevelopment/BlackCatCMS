			...
			<div class="settings_label fc_settings_max" id="fc_operating_system">
				<input type="radio" class="fc_radio_jq fc_toggle_element show___fc_linux" name="operating_system" id="fc_operating_system_linux" value="linux" {% if values.operating_system == 'linux' %} checked="checked"{% endif %}>
				<label for="fc_operating_system_linux">{{translate('Linux/Unix based')}}</label>
				<input type="radio" class="fc_radio_jq fc_toggle_element hide___fc_linux" name="operating_system" id="fc_operating_system_windows" value="windows" {% if values.operating_system == 'windows' %} checked="checked"{% endif %}>
				<label for="fc_operating_system_windows">{{translate('Windows')}}</label>
			</div>
			<div class="clear_sp"></div>

			<div id="fc_linux"{% if values.operating_system == 'windows' %} style="display:none;"{% endif %}>
				<div class="fc_settings_max">
					<input type="checkbox" class="fc_checkbox_jq" name="world_writeable" id="fc_world_writeable" value="true" {% if WORLD_WRITEABLE_SELECTED %} checked="checked"{% endif %}>
