			<label class="fc_label_200" for="fc_website_title">{translate('Website title')}:</label>
			...
			<label class="fc_label_200" for="fc_website_description">{translate('Website description')}:</label>
			...
			<label class="fc_label_200" for="fc_website_keywords">{translate('Website keywords')}:</label>
