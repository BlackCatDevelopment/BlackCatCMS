	...
	$.fn.fc_toggle_element = function (options)
	{
		...
		return this.each(function ()
		{
			...
			if ( current.is('select') )
			{
				...
				if ( current.children('option:selected').attr('rel') == 'hide' || according_div.hasClass('fc_inactive_element') )
				{
				...
				{
					if ( current.children('option:selected').attr('rel') == 'hide' )
					{
					...
					{
						according_div.removeClass('hidden').slideDown(options.toggle_speed, function()
						{
