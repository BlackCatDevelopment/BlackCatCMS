...
<head>
  ...
  <script  src="../jquery.effects.core.min.js"></script>
	<script  src="../jquery.effects.drop.min.js"></script>
	<?php echo _loadFile( '../presets/drop.preset' ); ?>
</head>
...
See <a href="http://docs.jquery.com/UI/Effects/Drop">http://docs.jquery.com/UI/Effects/Drop</a> for more details.
