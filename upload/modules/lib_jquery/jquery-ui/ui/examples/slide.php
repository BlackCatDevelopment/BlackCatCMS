...
<head>
  ...
  <script  src="../jquery.effects.core.min.js"></script>
	<script  src="../jquery.effects.slide.min.js"></script>
	<?php echo _loadFile( '../presets/slide.preset' ); ?>
</head>
...
See <a href="http://docs.jquery.com/UI/Effects/Slide">http://docs.jquery.com/UI/Effects/Slide</a> for more details.
