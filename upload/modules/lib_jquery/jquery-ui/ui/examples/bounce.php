...
<head>
  ...
  <script  src="../jquery.effects.core.min.js"></script>
	<script  src="../jquery.effects.bounce.min.js"></script>
	<?php echo _loadFile( '../presets/bounce.preset' ); ?>
</head>
...
See <a href="http://docs.jquery.com/UI/Effects/Bounce">http://docs.jquery.com/UI/Effects/Bounce</a> for more details.
