...
<head>
  ...
  <script  src="../jquery.effects.core.min.js"></script>
	<script  src="../jquery.effects.fold.min.js"></script>
	<?php echo _loadFile( '../presets/fold.preset' ); ?>
</head>
...
<tt>class="fold"</tt><br /><br />

to a &lt;div&gt;.<br /><br />

See <a href="http://docs.jquery.com/UI/Effects/Fold">http://docs.jquery.com/UI/Effects/Fold</a> for more details.
