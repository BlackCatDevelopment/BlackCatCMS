...
<head>
  ...
  <script  src="../jquery.effects.core.min.js"></script>
	<script  src="../jquery.effects.pulsate.min.js"></script>
	<?php echo _loadFile( '../presets/pulsate.preset' ); ?>
</head>
...
<tt>class="pulsate"</tt><br /><br />

to a &lt;div&gt;.<br /><br />

See <a href="http://docs.jquery.com/UI/Effects/Pulsate">http://docs.jquery.com/UI/Effects/Pulsate</a> for details.
