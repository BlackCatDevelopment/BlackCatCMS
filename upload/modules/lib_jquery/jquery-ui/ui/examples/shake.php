...
<head>
  ...
  <script  src="../jquery.effects.core.min.js"></script>
	<script  src="../jquery.effects.shake.min.js"></script>
	<?php echo _loadFile( '../presets/shake.preset' ); ?>
</head>
...
See <a href="http://docs.jquery.com/UI/Effects/Shake">http://docs.jquery.com/UI/Effects/Shake</a> for more details.
