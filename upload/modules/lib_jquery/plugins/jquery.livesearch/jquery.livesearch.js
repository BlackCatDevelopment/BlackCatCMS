...
{this.each(function()
{var element=$(this);if(element.data('livesearch'))return;var livesearch=new LiveSearch(this,options);element.data('livesearch',livesearch);});};$.fn.livesearch.defaults={queryDelay:250,innerText:"Search",minimumSearchLength:3};})(jQuery);