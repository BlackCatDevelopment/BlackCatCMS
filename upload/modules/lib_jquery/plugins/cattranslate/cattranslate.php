...
$attr = (string) ($val->get("_REQUEST", "attr") ?? "");
$msg = (string) ($val->get("_REQUEST", "msg") ?? "");

$msg = htmlspecialchars($msg, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8");
$attr = htmlspecialchars($attr, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8");
