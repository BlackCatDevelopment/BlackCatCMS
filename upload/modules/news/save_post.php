...
{
	$admin->print_error($MESSAGE['GENERIC']['FILL_IN_ALL'], CAT_URL.'/modules/news/modify_post.php?page_id='.$page_id.'&section_id='.$section_id.'&post_id='.$id);
}
else
{
...
make_dir(CAT_PATH.PAGES_DIRECTORY.'/posts/');
$file_create_time = '';
