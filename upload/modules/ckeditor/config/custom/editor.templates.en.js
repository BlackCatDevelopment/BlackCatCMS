...
CKEDITOR.addTemplates( 'default',
{
	...
	templates :
		[
			...
			{
				title: 'DIV within clear both.',
				image: 'template9.gif',
				description: 'DIV with clear:both. and a new paragraph.',
				html:
					'<div style="clear:both; height:1px; overflow:hidden;">&nbsp</div>' +
					'<p>...</p>'
			},
			{
				title: 'Textstop within BR',
				image: 'template9.gif',
				description: 'Simple BR with clear:both',
				html:
					'<br style="clear:both;" />...'
			},
			{
				title: 'Image left with subtitle.',
				image: 'template1.gif',
				description: 'Image left with subtitle.',
				html:
					'<div>' +
			...
			{
				title: 'Image right with subtitle',
				image: 'template4.gif',
				description: 'Image right with subtitle.',
				html:
					'<div>' +
