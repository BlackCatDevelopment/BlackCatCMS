jQuery(document).ready( function() {
    ...
    // Activate Ajax for Links having class 'ajaxAction'
    $('a.ajaxAction').click( function(e) {
        ...
        $('<div></div>').appendTo('body')
            .html(cattranslate('Are you sure?',null,null,'blackcatFilter'))
            .dialog({
                modal: true
                ,width: 350
                ,title: cattranslate('Are you sure?',null,null,'blackcatFilter')
                ,buttons: [
                {
