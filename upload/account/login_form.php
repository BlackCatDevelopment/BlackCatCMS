...
$username_fieldname = $username_fieldname
    ? $username_fieldname
    : CAT_Helper_Validate::createFieldname("username_");
$password_fieldname = CAT_Helper_Validate::sanitizePost("password_fieldname");
$password_fieldname = $password_fieldname
    ? $password_fieldname
    : CAT_Helper_Validate::createFieldname("password_");
...
$redirect_url =
    CAT_Helper_Validate::sanitizeGet("redirect") != ""
        ? CAT_Helper_Validate::sanitizeGet("redirect")
        : CAT_Helper_Validate::sanitizePost("redirect");
if (CAT_Helper_Validate::sanitizeGet("q") != "") {
    $redirect_url =
        str_replace(".php", "", $redirect_url) .
        "/" .
        CAT_Helper_Validate::sanitizeGet("q");
}

// get input data
$user = htmlspecialchars(
    CAT_Helper_Validate::sanitizePost($username_fieldname),
    ENT_QUOTES
);
