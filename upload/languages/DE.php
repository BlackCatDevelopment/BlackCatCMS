...
// ----- ./account folder -----
    ...
    'The username you entered is already taken' => 'Der angegebene Benutzername (Kennung) wird bereits verwendet',
...
// ----- page -----
    ...
    'Currently, no extra files are defined' => 'Zur Zeit sind keine Extra-Dateien konfiguriert',
    'Delete' => 'Löschen',
    ...
    'Please choose a file to edit' => 'Bitte eine Datei zum Bearbeiten auswählen',
    ...
    'Please note: By default, all *.js and *.css files in the plugin\'s folder are added to the list. You may have to remove some in the next step.' => 'Hinweis: Standardmäßig werden alle *.js und *.css Dateien hinzugefügt, die im Plugin-Verzeichnis vorgefunden werden. Bei Bedarf können überzählige Dateien im nächsten Schritt wieder entfernt werden.',
    ...
    'You can manage Javascript- and CSS-Files resp. jQuery plugins to be loaded into the page header here.' => 'Hier können Javascript- und CSS-Dateien bzw. jQuery Plugins verwaltet werden, die in den Seitenkopf geladen werden sollen.',
...
// ----- settings -----
    ...
    'You can manage global Javascript- and CSS-Files resp. jQuery plugins to be loaded into all page headers here.' => 'Hier können globale Javascript- und CSS-Dateien bzw. jQuery Plugins verwaltet werden, die auf allen Seiten in den Seitenkopf geladen werden sollen.',
...
// ----- media -----
    ...
    'Do you really want to delete this folder?' => 'Soll dieses Verzeichnis wirklich gelöscht werden?',
...
// ----- users/groups -----
    ...
    'The user can add new root pages' => 'Der Benutzer darf neue Basisseiten (Level 0) anlegen',
    'The user can delete pages' => 'Der Benutzer darf Seiten löschen',
    'The user can enter the backend' => 'Der Benutzer darf das Backend aufrufen',
    'The user can modify existing content' => 'Der Benutzer darf bestehende Inhalte ändern',
    'The user can modify page settings' => 'Der Benutzer darf Seiteneinstellungen ändern',
    'The user can modify the intro page' => 'Der Benutzer darf die Einstiegsseite ändern',
    'The user can see the pages tree in the backend' => 'Der Benutzer sieht den Seitenbaum im Backend',
