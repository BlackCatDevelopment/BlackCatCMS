...
// ----- page -----
    ...
    'Please note: At the moment, the two global options (by language / by sub domain) are mutually exclusive. If you need a more enhanced solution, please let us know.' => 'Bitte beachten: Derzeit schließen sich die beiden globalen Optionen (nach Sprache / nach Subdomain) gegenseitig aus. Bitte lassen Sie es uns wissen, wenn Sie eine erweiterte Lösung benötigen.',
