...
// ----- page -----
    ...
    'Enter the name of the subdomain and set the page from the list of pages.' => 'Geben Sie den Namen der Subdomain an und wählen Sie die entsprechende Seite aus der Liste.',
    'Forward user by browser language' => 'Benutzer nach Browsersprache weiterleiten',
    ...
    'If you choose the option "Disabled" and save, the intro.php will be deleted!' => 'Bei Auswahl von "Deaktiviert" wird die intro.php beim Speichern gelöscht!',
    ...
    'Please note: At the moment, the two global options (by language / by sub domain) are mutually exclusive.' => 'Bitte beachten: Derzeit schließen sich die beiden globalen Optionen (nach Sprache / nach Subdomain) gegenseitig aus.',
    ...
    'Target' => 'Ziel',
    'The intro page will be created automatically if you enable one or more options.' => 'Die Einstiegsseite wird automatisch erzeugt, sobald eine der Optionen aktiviert wird.',
    'The visitor will be forwarded depending on his browser language' => 'Der Besucher wird auf Basis der eingestellten Browsersprache weitergeleitet',
    'The visitor will be forwarded by analyzing the subdomain' => 'Der Besucher wird auf Basis der Subdomain weitergeleitet',
...
// ----- settings -----
    ...
    'A user can have an individual start page in the backend. Enable this option to use this feature. The start page is set in the user settings.' => 'Benutzer können individuelle Einstiegsseiten im Backend haben. Diese Option aktivieren, um diese Funktion zu nutzen. Die Startseite wird in den Benutzereinstellungen gesetzt.',
    'After some actions, success or error messages are displayed. This is the time such messages are shown before the backend redirects you back to the calling page.' => 'Nach manchen Aktionen werden zunächst Erfolgs- oder Fehlernachrichten angezeigt. Dies ist die Zeit, bevor zur aufrufenden Seite zurückgeleitet wird.',
    ...
    'Allows to set a minimal login name length. Good values start with 5 chars. Please note that this should not be changed if a large number of users already exists.' => 'Erlaubt das Setzen einer Mindestlänge für Benutzerkennungen. Gute Werte beginnen mit 5 Zeichen. Diese Einstellung sollte nicht mehr verändert werden, wenn es schon viele Benutzerkonten gibt.',
    'Allows to set a minimal password length. Please note that longer passwords are more secure.' => 'Erlaubt das Setzen einer Minimallänge für Kennworte. Längere Kennworte sind in der Regel sicherer.',
    'Allows to use email addresses as login names. Influences the list of allowed chars in the user login.' => 'Erlaubt die Verwendung von Mailadressen als Loginnamen. Beeinflußt die Liste erlaubter Zeichen im Loginnamen.',
    ...
    'If no editors are listed here, you have to install one first.' => 'Wenn hier keine Editoren aufgelistet sind, muß zunächst einer installiert werden.',
    'If the frontend template supports this, a login box is rendered on the frontpage. You may also use the Login box Droplet for this case.' => 'Sofern das Frontend-Template es unterstützt, wird eine Loginbox angezeigt. Alternativ kann das Loginbox Droplet verwendet werden.',
    ...
    'In maintenance mode, only the page you choose here will be exposed to the visitor. All other pages are redirected to the maintenance page.' => 'Im Wartungsmodus ist nur die hier eingestellte Seite für den Besucher zugänglich. Alle anderen Seiten werden auf die Wartungsseite umgeleitet.',
    ...
    'Select the frontend template you wish to use as default. You can choose different templates on a per-page-level.' => 'Das Standard-Template für das Frontend auswählen. Es können seitenbasiert abweichende Templates eingestellt werden.',
    'SEO settings' => 'SEO Einstellungen',
    'Server Operating System' => 'Serverbetriebssystem',
    'Server settings' => 'Servereinstellungen',
    'Session identifier' => 'Session ID',
    'You have to log in again if you change this value.'	=>'Sie müssen sich erneut einloggen, wenn sie diesen Wert ändern.',
    'Session path'	=> 'Pfad zur Session',
    'Sets which PHP errors are reported. For development, use E_ALL&E_STRICT. For production, use E_NONE.' => 'Bestimmt, welche PHP-Fehler berichtet werden. Für Entwicklungsumgebungen E_ALL&E_STRICT verwenden. Für Produktionsumgebungen E_NONE.',
    ...
    'The template may use this as a global footer.' => 'Das Template kann dies als globalen Seitenfuß verwenden.',
    'The template may use this as a global header.' => 'Das Template kann dies als globalen Seitenkopf verwenden.',
    'This is the charset to be used for both the frontend and the backend. We recommend to use UTF-8.' => 'Dies ist der Zeichensatz für Frontend und Backend. Wir empfehlen UTF-8 zu verwenden.',
    'This is the default date format. This setting will be used for guests and as a default for new users.' => 'Das Standard-Datumsformat. Diese Einstellung wird für Gäste und neu erstellte Benutzerkonten verwendet.',
    'This is the default timezone. This setting will be used for guests and as a default for new users.' => 'Das Standard-Zeitzone. Diese Einstellung wird für Gäste und neu erstellte Benutzerkonten verwendet.',
    'This is the default language of the system.' => 'Die Standard-Sprache des Systems.',
    'This is the default timezone. This setting will be used for guests and as a default for new users.' => 'Die Standard-Zeitzone. Diese Einstellung wird für Gäste und neu erstellte Benutzerkonten verwendet.',
    ...
    'Used for the keywords META attribute. Most search engines do not use this anymore.' => 'Wird für das keywords-META-Attribut verwendet. Die meisten Suchmaschinen verwenden diese Werte nicht mehr.',
...
// ----- addons - backend_addons_index.tpl -----
    ...
    'Same or newer version already installed' => 'Gleiche oder neuere Version bereits installiert',
...
// ----- addons catalog -----
    ...
    'Do you really want to install this addon?' => 'Soll dieses Addon wirklich installiert werden?',
    'Do you really want to uninstall this addon?' => 'Soll dieses Addon wirklich deinstalliert werden?',
    'Do you really want to upgrade this addon?' => 'Soll dieses Addon wirklich aktualisiert werden?',
    'Install...' => 'Installiere...',
