...
class admin extends wb
{
	...
	public function register_backend_modfiles_body($file_id="js") {
		...
		if($file_id == "js") {
			$base_link = '<script type="text/javascript" src="'.LEPTON_URL.'/modules/{MODULE_DIRECTORY}/backend_body.js"></script>';
		...
		if(isset($_GET['tool']))
			...
			if($result->numRows())
				...
				if(file_exists(LEPTON_PATH ."/modules/" .$tool['directory'] ."/$base_file"))
				{
	...
	public function register_backend_modfiles($file_id="css") {
		...
		$head_links = "";
		if($file_id == "css") {
      	$base_link = '<link href="'.LEPTON_URL.'/modules/{MODULE_DIRECTORY}/backend.css"';
			$base_link.= ' rel="stylesheet" type="text/css" media="screen" />';
			$base_file = "backend.css";
		} else {
			$base_link = '<script type="text/javascript" src="'.LEPTON_URL.'/modules/{MODULE_DIRECTORY}/backend.js"></script>';
