...
INSERT INTO `cat_settings` (name, value) VALUES
    ...
    ('github_proxy', ''),
    ('github_proxy_port', ''),
    ('github_catalog_location','https://raw.githubusercontent.com/BlackCatDevelopment/bcExtensionsCatalog/master/catalog.json'),
    ('home_folders', 'true'),
...
INSERT INTO `cat_class_secure` ( `module`, `filepath`) VALUES
    ...
    ( 0, '/backend/addons/ajax_update_catalog.php'),
    ...
    ( 0, '/backend/pages/ajax_headers.php' ),
...
INSERT INTO `cat_system_permissions` (`perm_name`, `perm_group`, `perm_bit`, `perm_for`, `perm_comment`) VALUES
	...
	('settings', 'settings', 1, 'BE', ''),
	('settings_basic', 'settings', 2, 'BE', ''),
	('settings_advanced', 'settings', 4, 'BE', ''),
	('access', 'access', 1, 'BE', ''),
