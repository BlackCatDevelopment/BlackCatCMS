...
<table>
  <tbody>
	...
	<tr{if $errors.installer_database_password || $errors.global} class="fail"{/if}>
	...
	<tr{if $errors.installer_database_password || $errors.global} class="fail"{/if}>
      ...
      <td>
    	...
    	{if $errors.installer_database_password_empty}{translate("You have set an empty password. Please check the checkbox above to confirm that this is really what you want.")}{/if}
      </td>
    </tr>
